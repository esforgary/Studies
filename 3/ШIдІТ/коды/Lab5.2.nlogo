...
globals [all-positions x-positions y-positions queens-positions]
...
to db-placement
  set queens-positions []
  ask figures [
    let pos n-of 1 all-positions
    set queens-positions lput pos queens-positions
    move-to-cell last pos
  ]
end
...
to set-positions
  ...
  set y-positions n-values max-y [ [j] -> (j + 1) ]
